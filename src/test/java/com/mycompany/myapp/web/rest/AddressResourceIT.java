...
class AddressResourceIT {
    ...
    public static Address createEntity() {
        return new Address().country(DEFAULT_COUNTRY).city(DEFAULT_CITY).street(DEFAULT_STREET).zipcode(DEFAULT_ZIPCODE);
    }
    ...
    public static Address createUpdatedEntity() {
        return new Address().country(UPDATED_COUNTRY).city(UPDATED_CITY).street(UPDATED_STREET).zipcode(UPDATED_ZIPCODE);
    }
    ...
    void putExistingAddress() throws Exception {
        ...
        updatedAddress.country(UPDATED_COUNTRY).city(UPDATED_CITY).street(UPDATED_STREET).zipcode(UPDATED_ZIPCODE);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.country(UPDATED_COUNTRY).city(UPDATED_CITY).street(UPDATED_STREET).zipcode(UPDATED_ZIPCODE);
