...
class ReviewResourceIT {
    ...
    public static Review createEntity() {
        return new Review().desc(DEFAULT_DESC).grade(DEFAULT_GRADE);
    }
    ...
    public static Review createUpdatedEntity() {
        return new Review().desc(UPDATED_DESC).grade(UPDATED_GRADE);
    }
    ...
    void putExistingReview() throws Exception {
        ...
        updatedReview.desc(UPDATED_DESC).grade(UPDATED_GRADE);
    ...
    void fullUpdateReviewWithPatch() throws Exception {
        ...
        partialUpdatedReview.desc(UPDATED_DESC).grade(UPDATED_GRADE);
