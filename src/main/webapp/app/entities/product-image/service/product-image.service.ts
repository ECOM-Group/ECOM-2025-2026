...
export class ProductImageService {
  ...
  uploadImage(file: File, productId: number): Observable<HttpResponse<IProductImage>> {
    const formData = new FormData();
    formData.append('file', file);
    formData.append('productId', productId.toString());

    return this.http.post<IProductImage>(`/api/product-images/upload`, formData, { observe: 'response' });
  }
}
