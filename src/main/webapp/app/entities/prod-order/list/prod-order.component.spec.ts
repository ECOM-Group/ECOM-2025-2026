...
import { sampleWithRequiredData } from '../prod-order.test-samples';
import { ProdOrderService } from '../service/prod-order.service';

import { ProdOrderComponent } from './prod-order.component';
import SpyInstance = jest.SpyInstance;

describe('ProdOrder Management Component', () => {
  let comp: ProdOrderComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProdOrderComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.prodOrders()[0]).toEqual(expect.objectContaining({ id: 15696 }));
  });

  describe('trackId', () => {
    it('should forward to prodOrderService', () => {
      const entity = { id: 15696 };
      jest.spyOn(service, 'getProdOrderIdentifier');
      const id = comp.trackId(entity);
      expect(service.getProdOrderIdentifier).toHaveBeenCalledWith(entity);
